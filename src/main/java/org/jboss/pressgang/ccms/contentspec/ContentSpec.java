...
public class ContentSpec extends Node {
    ...
    public void appendKeyValueNode(final KeyValueNode<?> node) throws NumberFormatException {
        ...
        } else if (uppercaseKey.equals(CSConstants.BUGZILLA_KEYWORDS_TITLE.toUpperCase(Locale.ENGLISH)) && value instanceof String) {
    ...
    public String toString() {
        ...
        for (final Node node : nodes) {
            if (node instanceof KeyValueNode) {
                ...
                if (!keyValueNode.getKey().equals(CSConstants.CHECKSUM_TITLE) && !keyValueNode.getKey().equals(CSConstants.ID_TITLE) && !keyValueNode.getKey().equals(
                        "SpecRevison")) {
