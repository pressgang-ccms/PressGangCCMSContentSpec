...
public class RESTReader {
    ...
    public RESTTopicV1 getTopicById(final int id, final Integer rev, final boolean expandTranslations) {
        try {
            ...
            if (entityCache.containsKeyValue(RESTTopicV1.class, id, rev)) {
                ...
                final ExpandDataTrunk expandTopicTranslations = new ExpandDataTrunk(
                        new ExpandDataDetails(RESTTopicV1.TRANSLATEDTOPICS_NAME));
    ...
    public RESTTopicCollectionV1 getTopicsByIds(final List<Integer> ids, final boolean expandTranslations) {
        ...
        try {
            ...
            if (query.length() != "query;topicIds=".length()) {
                ...
                final ExpandDataTrunk expandTranslatedTopics = new ExpandDataTrunk(
                        new ExpandDataDetails(RESTTopicV1.TRANSLATEDTOPICS_NAME));
                final ExpandDataTrunk expandSourceUrls = new ExpandDataTrunk(new ExpandDataDetails(RESTTopicV1.SOURCE_URLS_NAME));
                ...
                if (expandTranslations) {
                    ...
                    topicsExpand.setBranches(
                            CollectionUtilities.toArrayList(tags, /*outgoingRelationships,*/ properties, expandSourceUrls));
                }
    ...
    public RESTTranslatedTopicCollectionV1 getTranslatedTopicsByTopicIds(final List<Integer> ids, final String locale) {
        ...
        try {
            ...
            for (final Integer id : ids) {
                if (!entityCache.containsKeyValue(RESTTranslatedTopicV1.class, id) && !entityCache.containsKeyValue(
                        RESTTranslatedTopicV1.class, (id * -1))) {
                    urlVars.append(id + ",");
            ...
            if (query.length() != "query;latestTranslations=true;topicIds=".length()) {
                ...
                final ExpandDataTrunk topicExpandTranslatedTopics = new ExpandDataTrunk(
                        new ExpandDataDetails(RESTTopicV1.TRANSLATEDTOPICS_NAME));
                final ExpandDataTrunk tags = new ExpandDataTrunk(new ExpandDataDetails(RESTTranslatedTopicV1.TAGS_NAME));
                final ExpandDataTrunk properties = new ExpandDataTrunk(new ExpandDataDetails(RESTBaseTopicV1.PROPERTIES_NAME));
                final ExpandDataTrunk categories = new ExpandDataTrunk(new ExpandDataDetails(RESTTagV1.CATEGORIES_NAME));
                //final ExpandDataTrunk outgoingRelationships = new ExpandDataTrunk(new ExpandDataDetails(RESTTranslatedTopicV1
                // .ALL_LATEST_OUTGOING_NAME));
     ...
     */
    public RESTTranslatedTopicStringCollectionV1 getTranslatedTopicStringsByTopicId(final Integer id, final Integer rev,
            final String locale) {
        ...
        try {
            final List<String> additionalKeys = CollectionUtilities.toArrayList("revision" + rev,
                    "translatedTopic" + translatedTopic.getId());
            if (collectionsCache.containsKey(RESTTranslatedTopicStringV1.class, additionalKeys)) {
                ...
                final ExpandDataTrunk expandTranslatedStrings = new ExpandDataTrunk(
                ...
                collectionsCache.add(RESTTranslatedTopicStringV1.class, translatedTopicStrings.getTranslatedTopicStrings_OTM(),
                        additionalKeys);
     ...
     */
    public RESTTranslatedTopicV1 getClosestTranslatedTopicByTopicId(final Integer id, final Integer rev, final String locale,
        ...
        if (topic.getTranslatedTopics_OTM() != null && topic.getTranslatedTopics_OTM().getItems() != null) {
            ...
            for (final RESTTranslatedTopicV1 translatedTopic : translatedTopics) {
                if (translatedTopic.getLocale().equals(locale)
						...
						/* Ensure that the translation revision is less than or equal to the revision specified */ && (rev == null || translatedTopic
                        .getTopicRevision() <= rev)) {
    ...
    public RESTTopicV1 getContentSpecById(final int id, final Integer rev, final boolean expandTranslations) {
        ...
        final List<RESTTagV1> topicTypes = ComponentBaseTopicV1.returnTagsInCategoriesByID(cs,
                CollectionUtilities.toArrayList(CSConstants.TYPE_CATEGORY_ID));
                ...
                if (type.getId().equals(CSConstants.CONTENT_SPEC_TAG_ID)) {
                    ...
                    for (final RESTTranslatedTopicV1 topic : topics) {
                        if (topic.getLocale().equals(
                                locale) && (latestTranslatedTopic == null || latestTranslatedTopic.getTopicRevision() < topic
                                .getTopicRevision())) {
        ...
        try {
            ...
            if (collectionsCache.containsKey(RESTTopicV1.class, additionalKeys)) {
                ...
                expandRevs.setBranches(
                        CollectionUtilities.toArrayList(new ExpandDataTrunk(new ExpandDataDetails(RESTTopicV1.PROPERTIES_NAME))));
        ...
        try {
            ...
            if (collectionsCache.containsKey(RESTTopicV1.class, additionalKeys)) {
                ...
                expandTags.setBranches(
                        CollectionUtilities.toArrayList(new ExpandDataTrunk(new ExpandDataDetails(RESTTagV1.CATEGORIES_NAME))));
                expandTopics.setBranches(CollectionUtilities.toArrayList(expandTags,
                        new ExpandDataTrunk(new ExpandDataDetails(RESTTopicV1.PROPERTIES_NAME))));
    ...
    public RESTTopicV1 getPreContentSpecById(final Integer id, final Integer revision, final Integer startLimit, final Integer endLimit,
            final boolean recursive, final int increment) {
    ...
    public RESTTopicV1 getPostContentSpecById(final Integer id, final Integer revision, final Integer startLimit, final Integer endLimit,
            final boolean recursive, final int increment, final boolean expandTranslations) {
            ...
            if (topic != null) {
                ...
                for (final RESTTopicV1 topicRevision : topicRevisions) {
                    if (topicRevision.getRevision().equals(rev)) {
                        List<RESTTagV1> writerTags = ComponentBaseTopicV1.returnTagsInCategoriesByID(topicRevision,
    ...
    public AuthorInformation getAuthorInformation(final Integer authorId) {
        ...
        if (tag != null && ComponentBaseRESTEntityWithPropertiesV1.returnProperty(tag,
                CSConstants.FIRST_NAME_PROPERTY_TAG_ID) != null && ComponentBaseRESTEntityWithPropertiesV1.returnProperty(tag,
                CSConstants.LAST_NAME_PROPERTY_TAG_ID) != null) {
            authInfo.setFirstName(
                    ComponentBaseRESTEntityWithPropertiesV1.returnProperty(tag, CSConstants.FIRST_NAME_PROPERTY_TAG_ID).getValue());
            authInfo.setLastName(
                    ComponentBaseRESTEntityWithPropertiesV1.returnProperty(tag, CSConstants.LAST_NAME_PROPERTY_TAG_ID).getValue());
            if (ComponentBaseRESTEntityWithPropertiesV1.returnProperty(tag, CSConstants.EMAIL_PROPERTY_TAG_ID) != null) {
                authInfo.setEmail(
                        ComponentBaseRESTEntityWithPropertiesV1.returnProperty(tag, CSConstants.EMAIL_PROPERTY_TAG_ID).getValue());
            }
            if (ComponentBaseRESTEntityWithPropertiesV1.returnProperty(tag, CSConstants.ORGANIZATION_PROPERTY_TAG_ID) != null) {
                authInfo.setOrganization(
                        ComponentBaseRESTEntityWithPropertiesV1.returnProperty(tag, CSConstants.ORGANIZATION_PROPERTY_TAG_ID).getValue());
            }
            if (ComponentBaseRESTEntityWithPropertiesV1.returnProperty(tag, CSConstants.ORG_DIVISION_PROPERTY_TAG_ID) != null) {
                authInfo.setOrgDivision(
                        ComponentBaseRESTEntityWithPropertiesV1.returnProperty(tag, CSConstants.ORG_DIVISION_PROPERTY_TAG_ID).getValue());
            }
            return authInfo;
        }
        return null;
